...
CREATE PROCEDURE PROC_REGISTRAR_CATEGORIA
...
CREATE PROCEDURE PROC_MODIFICAR_CATEGORIA
    @id_categoria INT,
    @nombre_categoria NVARCHAR(50)
AS
BEGIN
...
CREATE PROCEDURE PROC_NOMBRE_CATEGORIA_EXISTE
    @id_categoria INT,
    @nombre_categoria NVARCHAR(50),
    @existe BIT OUTPUT
AS
...
CREATE PROCEDURE PROC_DAR_DE_BAJA_CATEGORIA
    @id_categoria INT,
